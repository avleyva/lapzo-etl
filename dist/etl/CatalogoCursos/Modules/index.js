...
exports.startCatalogModulesPipeline = void 0;
...
const mainLoadFn = async () => {
    ...
    try {
        ...
        const totalChunks = Math.ceil(newModulesForLMS.length / utils_1.MAX_RECORDS_TO_INSERT);
        for (let i = 0, cont = 1; i < newModulesForLMS.length; i += utils_1.MAX_RECORDS_TO_INSERT, cont++) {
            chunk = newModulesForLMS.slice(i, i + utils_1.MAX_RECORDS_TO_INSERT);
 ...
 */
const startCatalogModulesPipeline = async () => {
    console.log('\n**************************************');
...
exports.startCatalogModulesPipeline = startCatalogModulesPipeline;
