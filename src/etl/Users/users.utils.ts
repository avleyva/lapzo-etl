import { LXPUser } from './users.types';

export const getGenericUsers = async (clientId: string) => {
  const roles: any = {
    admin: 'ADMIN',
  ...
  for (const role in roles) {
    const userTmp: LXPUser = {
      ...
      image_url:
        'https://res.cloudinary.com/lernit/image/upload/v1691380743/Courses/yeh6dbwloqpbeldtak9t.png',
